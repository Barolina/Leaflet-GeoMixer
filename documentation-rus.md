...
bounds|`<L.LatLngBounds>`|Весь мир| Прямоугольник отслеживания объектов в формате [L.LatLngBounds](http://leafletjs.com/reference.html#latlngbounds)
...
callback|`Func(Observer data)`||Производится отбор объектов по заданным условиям: `bounds`, `dateInterval` и `filters`.
